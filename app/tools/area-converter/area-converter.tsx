...
export default function AreaConverter() {
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Area Converter</CardTitle>
        <p className="text-muted-foreground">
          Convert between square meters, hectares, acres, and other area units. Enter a value and select your units below.
        </p>
      </CardHeader>
