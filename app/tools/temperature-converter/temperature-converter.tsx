...
export default function TemperatureConverter() {
  ...
  const result = value ? convert(parseFloat(value), fromUnit, toUnit).toFixed(2) : '0'

  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Temperature Converter</CardTitle>
        <p className="text-muted-foreground">
          Convert between Celsius, Fahrenheit, and Kelvin temperature units. Enter a value and select your units below.
        </p>
      </CardHeader>
