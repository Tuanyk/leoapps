...
export default function WeightConverter() {
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Weight Converter</CardTitle>
        <p className="text-muted-foreground">
          Convert between kilograms, pounds, tons, and other weight units. Enter a value and select your units below.
        </p>
      </CardHeader>
